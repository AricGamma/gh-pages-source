    ...
    <section>
        ...
        <div class="panel">
            <div ref="carouselElement" :id="id" class="relative" data-twe-carousel-init data-twe-carousel-slide
                data-twe-ride="carousel" data-twe-interval="5000">
                ...
                <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                    <div v-for="(item, i) in items" :key="i" :ref="(el: any) => carouselItems[i] = el"
                        ...
                        <div class="item-content">
                            ...
                            <video :ref="(el: any) => videos[i] = el" v-lazy :src="item.video" muted loop
                                autoplay></video>
                        </div>
                    </div>
                </div>
...
const items = (props.items || []).map(sub => ({ text: sub.text, video: new URL(`../${sub.video}`, import.meta.url).href }))
